...
const Home = () => {
 ...
 return (
  <div className="relative flex min-h-screen flex-col justify-center overflow-hidden bg-neutral-900 py-6 sm:py-12">
    ...
    <h1 className="text-3xl font-medium mb-8 text-white">¡ Bienvenid@ a <span className='text-[#FB005A] font-semibold'>Innova</span><span className='text-[#FFFF] font-semibold'>Tech</span>, {user && user.name} 👋 !</h1>
